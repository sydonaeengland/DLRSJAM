// App entry — defines all routes and wraps everything in auth and application context providers.
...
import OfficerReviewApplication  from "./pages/officer/OfficerReviewApplication"

// Supervisor portal
import SupervisorDashboard         from "./pages/supervisor/SupervisorDashboard"
import SupervisorReviewApplication from "./pages/supervisor/SupervisorReviewApplication"
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/applications/:id" element={
              <ProtectedRoute role="applicant"><ApplicationRouter /></ProtectedRoute>
            } />
            ...
            <Route path="/apply/verification"         element={<ProtectedRoute role="applicant"><Verification /></ProtectedRoute>} />
            <Route path="/apply/review"               element={<ProtectedRoute role="applicant"><Review /></ProtectedRoute>} />
            <Route path="/apply/declaration"          element={<ProtectedRoute role="applicant"><Declaration /></ProtectedRoute>} />
            <Route path="/apply/payment"              element={<ProtectedRoute role="applicant"><Payment /></ProtectedRoute>} />
            <Route path="/apply/success"              element={<ProtectedRoute role="applicant"><Success /></ProtectedRoute>} />
            ...
            <Route path="/officer/review/:id" element={
              <ProtectedRoute role="officer"><OfficerReviewApplication /></ProtectedRoute>
            } />
            ...
            <Route path="/supervisor/review/:id" element={
              <ProtectedRoute role="supervisor"><SupervisorReviewApplication /></ProtectedRoute>
            } />
